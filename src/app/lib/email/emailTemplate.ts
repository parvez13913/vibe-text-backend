export function WelcomeEmailTemplate(name: string, clientURL: string): string {
  return `
  <!DOCTYPE html>
  <html lang="en">
  <head>
  ...
  <body style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px; background-color: #f9f9f9;">
    <div style="background: linear-gradient(to right, #6a5acd, #8a2be2); padding: 30px; text-align: center; border-radius: 12px 12px 0 0;">
    ...
    <div style="background-color: #ffffff; padding: 35px; border-radius: 0 0 12px 12px; box-shadow: 0 4px 15px rgba(0,0,0,0.05);">
      <p style="font-size: 18px; color: #6a5acd;"><strong>Hello ${name},</strong></p>
      ...
      <div style="background-color: #f0f4f8; padding: 25px; border-radius: 10px; margin: 25px 0; border-left: 4px solid #8a2be2;">
      ...
      <div style="text-align: center; margin: 30px 0;">
        <a href="${clientURL}" style="background: linear-gradient(to right, #6a5acd, #8a2be2); color: white; text-decoration: none; padding: 12px 30px; border-radius: 50px; font-weight: 500; display: inline-block;">Open Messenger</a>
      </div>
